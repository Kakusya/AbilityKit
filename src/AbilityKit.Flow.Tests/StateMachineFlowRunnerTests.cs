...
public sealed class StateMachineFlowRunnerTests
{
    ...
    public void Ctor_rejects_null_arguments()
    {
        Assert.Throws<ArgumentNullException>(
            () => new StateMachineFlowRunner<string, string, string>(null, NewMachine(out _, out _), new FlowEventQueue<string>()));
        Assert.Throws<ArgumentNullException>(
            () => new StateMachineFlowRunner<string, string, string>(new FlowContext(), null, new FlowEventQueue<string>()));
        Assert.Throws<ArgumentNullException>(
            () => new StateMachineFlowRunner<string, string, string>(new FlowContext(), NewMachine(out _, out _), null));
    }
    ...
    public void Exposes_context_machine_and_events()
    {
        ...
        using var runner = new StateMachineFlowRunner<string, string, string>(ctx, machine, events);
    ...
    public void Start_enters_start_state_only_once()
    {
        ...
        using var runner = new StateMachineFlowRunner<string, string, string>(new FlowContext(), machine, new FlowEventQueue<string>());
    ...
    public void Step_drains_all_queued_events_before_logic()
    {
        ...
        events.Enqueue("go");
        events.Enqueue("back");
        using var runner = new StateMachineFlowRunner<string, string, string>(new FlowContext(), machine, events);
    ...
    {
        var machine = NewMachine(out var a, out _);
        var runner = new StateMachineFlowRunner<string, string, string>(new FlowContext(), machine, new FlowEventQueue<string>());

...
- [`Document/README.md`](../Document/README.md)：包定位、正式主线、扩展方式与文档总索引。
- [`Document/StageClosureGuide.md`](../Document/StageClosureGuide.md)：阶段性可用包结论、接入路径、对象池建议与后续测试流程。
- [`Document/FormalApiBoundary.md`](../Document/FormalApiBoundary.md)：正式 API 边界。

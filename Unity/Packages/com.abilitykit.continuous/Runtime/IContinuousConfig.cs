...
namespace AbilityKit.Continuous
{
    /// <summary>
    /// 持续体配置接口（核心，最小化）
    /// 
    ...
    {
        /// <summary>Returns whether this container contains the specified tag.</summary>
        bool HasTag(string tag);

        /// <summary>Returns whether this container overlaps another tag container.</summary>
        bool HasAny(ITagContainer other);

        /// <summary>Gets the number of tags in this container.</summary>
        int Count { get; }
    }

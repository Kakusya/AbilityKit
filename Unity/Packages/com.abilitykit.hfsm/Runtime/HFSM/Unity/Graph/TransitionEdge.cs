    ...
    public class TransitionEdge
    {
        ...
        public List<TransitionCondition> Conditions
        {
            get
            {
                ...
                {
                    _conditions = ConditionSerializer.Deserialize(_conditionConfigJson);
        ...
        /// 获取条件列表（强制重新从JSON加载）
        /// </summary>
        public List<TransitionCondition> GetConditionsFresh()
        {
            _conditions = ConditionSerializer.Deserialize(_conditionConfigJson);
            _conditionsLoaded = true;
            return _conditions;
        ...
        public TransitionEdge(string sourceNodeId, string targetNodeId)
        {
            _id = Guid.NewGuid().ToString("N");
        ...
        {
            _conditions = _conditions ?? new List<TransitionCondition>();
            _conditionConfigJson = ConditionSerializer.Serialize(_conditions);
            _conditionsLoaded = true;
        }
        ...
        public TransitionEdge Clone()
        {
            var clone = new TransitionEdge();
            ...
            {
                clone._conditions = new List<TransitionCondition>();
